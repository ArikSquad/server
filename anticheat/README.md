...
An advanced prediction-based anticheat for Minestom. Features comprehensive packet tracking, movement prediction with
physics simulation, and lag compensation.
