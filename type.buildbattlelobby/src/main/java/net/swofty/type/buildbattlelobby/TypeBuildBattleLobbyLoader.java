package net.swofty.type.buildbattlelobby;
...
import net.swofty.type.buildbattlelobby.parkour.BuildBattleLobbyParkour;
...
public class TypeBuildBattleLobbyLoader implements LobbyTypeLoader {
    ...
    public ServerType getType() {
        return ServerType.BUILD_BATTLE_LOBBY;
    }
    ...
    public void afterInitialize(MinecraftServer server) {
        BuildBattleLobbyScoreboard.start();

        BuildBattleLobbyMap buildBattleLobbyMap = new BuildBattleLobbyMap();
        buildBattleLobbyMap.placeItemFrames(HypixelConst.getInstanceContainer());
    ...
    public Parkour getParkour() {
        return new BuildBattleLobbyParkour();
    }
    ...
    public List<LaunchPad> getLaunchPads() {
        return List.of(); // No launch pads for build battle lobby
    }
    ...
    public List<HypixelEventClass> getTraditionalEvents() {
        List<HypixelEventClass> events = new ArrayList<>(HypixelGenericLoader.loopThroughPackage(
                "net.swofty.type.buildbattlelobby.events",
    ...
    public List<HypixelEventClass> getCustomEvents() {
        return HypixelGenericLoader.loopThroughPackage(
                "net.swofty.type.buildbattlelobby.events.custom",
                HypixelEventClass.class
        ).toList();
    }
    ...
    public List<HypixelNPC> getNPCs() {
        return HypixelGenericLoader.loopThroughPackage(
                "net.swofty.type.buildbattlelobby.npcs",
                HypixelNPC.class
        ).toList();
    }
    ...
    public List<ServiceToClient> getServiceRedisListeners() {
        return HypixelGenericLoader.loopThroughPackage(
                "net.swofty.type.buildbattlelobby.redis.service",
    ...
    public @Nullable CustomWorlds getMainInstance() {
        return CustomWorlds.BUILD_BATTLE_LOBBY;
    }
}
