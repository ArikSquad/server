...
import net.swofty.type.buildbattlegame.role.GameRole;
...
public class BuildBattleGameScoreboard {
    ...
    public static void start() {
        ...
        scheduler.submitTask(() -> {
            ...
            for (Game game : TypeBuildBattleGameLoader.getGames()) {
                for (BuildBattlePlayer player : game.getPlayers()) {
